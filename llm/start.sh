...
export LLM_MODEL_ID="${LLM_MODEL_ID:-Qwen/Qwen3-14B}"
export LLM_MODEL_DIR="${LLM_MODEL_DIR:-./models/qwen3-14b}"
export EMBED_MODEL_ID="${EMBED_MODEL_ID:-BAAI/bge-m3}"
export EMBED_MODEL_DIR="${EMBED_MODEL_DIR:-./models/bge-m3}"
export LLM_TENSOR_PARALLEL_SIZE="${LLM_TENSOR_PARALLEL_SIZE:-2}"
export LLM_GPU_MEMORY_UTILIZATION="${LLM_GPU_MEMORY_UTILIZATION:-0.90}"
export EMBED_NUM_REPLICAS="${EMBED_NUM_REPLICAS:-2}"
